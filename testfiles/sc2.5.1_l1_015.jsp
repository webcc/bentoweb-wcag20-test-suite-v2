<%@page import="java.util.regex.*" %><%
 ...
 if (request.getMethod().equals("POST")) {
	if (request.getParameter("e1").equals("")) {
		errStr = "The <a href='#id1'>mail address</a> is required.";
		error = true;
   } else  {
      ...
      if (!matchFound) {
		  errStr = "The <a href='#id1'>mail address</a> does not seem to be valid.";
		  error = true;
      }
	}
   if (!error) {
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    ...
    <form method="post" action="sc2.5.1_l1_015.jsp">
    <div>
