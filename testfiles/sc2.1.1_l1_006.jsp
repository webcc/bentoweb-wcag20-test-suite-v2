...
<body>
	<form name="ss" id="sss" method="get" action="">
		<input type="image" name="themap" style="border:none;" src="resources/images/sc2.1.1_l1_003.gif" alt="navigation map (Text links follow)" />
	</form>
	<div title="alternative navigation" style="position:absolute;top:-10em">
