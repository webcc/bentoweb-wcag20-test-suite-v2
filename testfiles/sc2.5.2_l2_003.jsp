...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  ...
  <body>
    ...
    <form method="post" action="sc2.5.2_l2_003.jsp">
      ...
      <% if (error) {  out.println("<img src='resources/images/alert_icon.gif' width='16' height='16' alt='Alert!' /> <span class='errTxt'>Please provide a correct date.</span><br/>"); } %>
          <span class="leftcollarge">Date <label for="id1">(dd/</label><label for="id2">mm/</label><label for="id3">yyyy)</label> * : </span>
		...
		<% if (error) { out.println("<div class='space'><a href='#hd'>help</a><br/>");} %>
	    <% if (error) {  out.println("</div>");} %>
